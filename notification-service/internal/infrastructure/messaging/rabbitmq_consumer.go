...
func Run(ctx context.Context, source messageSource, dispatcher notification.EventDispatcher) error {
	for {
...
func runOnce(ctx context.Context, source messageSource, dispatcher notification.EventDispatcher) error {
