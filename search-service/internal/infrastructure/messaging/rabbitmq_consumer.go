...
func Run(ctx context.Context, source messageSource, dispatcher index.EventDispatcher) error {
	for {
...
func runOnce(ctx context.Context, source messageSource, dispatcher index.EventDispatcher) error {
