...
const (
	QueueName        = "customer_queue"
	DLXName          = "customer_dlx"
	MaxRetryAttempts = 3
)
...
func Run(ctx context.Context, source messageSource, dispatcher customer.EventDispatcher) error {
	for {
...
func runOnce(ctx context.Context, source messageSource, dispatcher customer.EventDispatcher) error {
