...
func (h *DeliveryHandler) UpdateDelivery(ctx *gin.Context) {
	reqCtx := ctx.Request.Context()

	var input resapp.UpdateDeliveryRequest
	...
	res, err := h.updateDelivery.Execute(reqCtx, restaurantID, ownerID, input)
	if err != nil {
