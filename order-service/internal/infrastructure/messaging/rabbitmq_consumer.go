...
func Run(ctx context.Context, source messageSource, dispatcher readmodel.EventDispatcher) error {
	for {
...
func runOnce(ctx context.Context, source messageSource, dispatcher readmodel.EventDispatcher) error {
